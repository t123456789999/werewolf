    ...
    <Fragment>
      <div>
        <FormControl className={classes.formControl}>
          <InputLabel htmlFor="role_guardian">{t('guard')}</InputLabel>
          <NativeSelect
            native
            value={isUseGuard}
            onChange={(e) => {setIsUseGuard(e.target.value === 'true')}}
            id="role_guardian"
          >
      ...
      <div>
        <FormControl className={classes.formControl}>
          <InputLabel htmlFor="role_wolfking">{t('wolf_king')}</InputLabel>
          <NativeSelect
            native
            value={isUseWolfKing}
            onChange={(e) => {setIsUseWolfKing(e.target.value === 'true')}}
            id="role_wolfking"
          >
            <option value={true}>{t('yes')}</option>
            <option value={false}>{t('no')}</option>
